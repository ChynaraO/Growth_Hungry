...
Далее через пробел записаны 𝑁 чисел — элементы массива. Массив состоит из натуральных чисел,
не превосходящих 200 (рост учеников в сантиметрах). Затем, на новой строке, вводится рост самого Пети.
...
входные данные
8
165 163 162 160 157 157 155 154
162
выходные данные
3
     */
    public static void main(String[] args) {
        ...
        int [] arr = new int[n];
         ...
         int PetesHeight = scanner.nextInt();
         int indexOrder = 1;
        for (int i = 0; i < arr.length; i++) {
            if(arr[i] >= PetesHeight){
                indexOrder++;
            }else{
                break;
            }
